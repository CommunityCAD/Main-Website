...
@section('content')
    <div class="relative isolate overflow-hidden bg-gray-900">
        <svg aria-hidden="true"
            ...
            <defs>
                <pattern height="200" id="983e3e4c-de6d-4c3f-8d64-b9761d1534cc" patternUnits="userSpaceOnUse" width="200"
                    x="50%" y="-1">
        ...
        <div class="mx-auto max-w-7xl px-6 pb-24 pt-5 sm:pb-32 lg:flex lg:px-8 lg:py-40">
            <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
                <div class="mt-24 sm:mt-32 lg:mt-16">
                    <a class="inline-flex space-x-6" href="{{ route('posts.just-ship-v1') }}">
                        <span
                ...
                <div class="mt-10 flex items-center gap-x-6">
                    <a class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400"
                        href="https://discord.gg/b4vduyWNfJ">Discord</a>
                    {{-- <a class="text-sm font-semibold leading-6 text-white" href="#">Docs <span
                            aria-hidden="true">→</span></a> --}}
                </div>
            </div>
            <div class="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
                <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                    <img alt="App screenshot" class="w-[76rem] rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10"
                        height="1442" src="{{ asset('images/LEO MDT Call Page.png') }}" width="2432">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="mx-auto max-w-2xl lg:max-w-none">
                ...
                <dl
                    ...
                    <div class="flex flex-col bg-white/5 p-8">
                        <dt class="text-sm font-semibold leading-6 text-gray-300"><img alt=""
                                src="{{ asset('images/bcrp.png') }}"></dt>
                        <dd class="order-first text-3xl font-semibold tracking-tight text-white">Blaine County Roleplay</dd>
                    </div>
                    {{-- <div class="flex flex-col bg-white/5 p-8">
            ...
            <dl
                ...
                <div class="relative pl-9">
                    <dt class="inline font-semibold text-white">
                        <svg aria-hidden="true" class="absolute left-1 top-1 h-5 w-5 text-indigo-500" fill="currentColor"
                            viewBox="0 0 20 20">
                            <path clip-rule="evenodd"
            ...
            <div class="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                <div class="rounded-3xl p-8 xl:p-10 ring-1 ring-white/10">
                    <div class="flex items-center justify-between gap-x-4">
                        <h3 class="text-lg font-semibold leading-8 text-white" id="tier-freelancer">Basic</h3>
                    </div>
                    ...
                    <ul class="mt-8 space-y-3 text-sm leading-6 text-gray-300 xl:mt-10" role="list">
                        <li class="flex gap-x-3">
                            <svg aria-hidden="true" class="h-6 w-5 flex-none text-white" class="text-green-600"
                        ...
                        <li class="flex gap-x-3">
                            <svg aria-hidden="true" class="h-6 w-5 flex-none text-white" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path clip-rule="evenodd"
                                    d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z"
                                    fill-rule="evenodd" />
                ...
                <div class="rounded-3xl p-8 xl:p-10 bg-white/5 ring-2 ring-indigo-500">
                    <div class="flex items-center justify-between gap-x-4">
                        <h3 class="text-lg font-semibold leading-8 text-white" id="tier-startup">Advanced</h3>
                ...
                <div class="rounded-3xl p-8 xl:p-10 ring-1 ring-white/10">
                    <div class="flex items-center justify-between gap-x-4">
                        <h3 class="text-lg font-semibold leading-8 text-white" id="tier-enterprise">Pro</h3>
                    </div>
    ...
    <div class="relative isolate overflow-hidden bg-gray-900">
        ...
        <svg aria-hidden="true"
            ...
            <circle cx="512" cy="512" fill-opacity="0.7" fill="url(#8d958450-c69f-4251-94bc-4e091a323369)"
                r="512" />
            <defs>
    ...
    <div class="bg-gray-900">
        <div class="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8">
            ...
            <p class="mt-6 max-w-2xl text-base leading-7 text-gray-300">Have a different question and can’t find the answer
                you’re looking for? Reach out to our support team via <a
                    class="font-semibold text-indigo-400 hover:text-indigo-300"
                    href="https://discord.gg/b4vduyWNfJ">joining Discord</a> and
                we’ll get back
