        ...
        <div class="flex-auto max-w-5xl min-w-0 px-4 py-10 mx-auto lg:pr-0 lg:pl-8 xl:px-16 text-white">
            <article class="">
                ...
                <p class="mt-2 text-xl text-slate-300">
                    This endpoint allows you to detach an unit from a call.
                </p>
                ...
                <div class="space-y-3" id="panic">
                    ...
                    <p class="">
                        ...
                        <span
                            class="inline-flex items-center rounded-md bg-gray-700 px-2 py-1 text-base font-medium text-gray-300 ring-1 ring-inset ring-blue-700/10">api/v1/emergency/detach_unit</span>
                    </p>
                            ...
                            <pre class="flex-1">
{
    ...
    "data": []
                    ...
                    <p>200 with no active unit attached.</p>
                    <code
                        class="text-sm sm:text-base inline-flex text-left items-center space-x-4 bg-gray-800 text-white rounded-lg p-4 pl-6">
                        <span class="flex gap-4">
                            <pre class="flex-1">
