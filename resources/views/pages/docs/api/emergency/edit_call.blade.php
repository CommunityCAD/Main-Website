        ...
        <div class="flex-auto max-w-5xl min-w-0 px-4 py-10 mx-auto lg:pr-0 lg:pl-8 xl:px-16 text-white">
            <article class="">
                ...
                <p class="mt-2 text-xl text-slate-300">
                    This endpoint allows you to edit calls.
                </p>
                ...
                <div class="space-y-3" id="create_call">
                    ...
                    <p class="">
                        ...
                        <span
                            class="inline-flex items-center rounded-md bg-gray-700 px-2 py-1 text-base font-medium text-gray-300 ring-1 ring-inset ring-blue-700/10">api/v1/emergency/edit_call</span>
                    </p>
...
{
"call_id": 123456,
"narrative": "Test narrative", // Optional
