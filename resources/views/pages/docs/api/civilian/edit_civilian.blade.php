            ...
            <article class="">
                ...
                <div class="space-y-3" id="panic">
                    ...
                    <p class="">
                        ...
                        <span
                            class="inline-flex items-center rounded-md bg-gray-700 px-2 py-1 text-base font-medium text-gray-300 ring-1 ring-inset ring-blue-700/10">api/v1/civilian/edit_civilian</span>
                    </p>
