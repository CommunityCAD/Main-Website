                ...
                <div class="space-y-3" id="panic">
                    ...
                    <div class="rounded-md bg-red-50 p-4 my-3">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <div class="text-sm text-red-700">
                                    <p>Endpoint has been updated v1.2.1.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <p class="">
                        ...
                        <span
                            class="inline-flex items-center rounded-md bg-gray-700 px-2 py-1 text-base font-medium text-gray-300 ring-1 ring-inset ring-blue-700/10">api/v1/emergency/panic</span>
                    </p>
                    ...
                    <table class="min-w-full divide-y divide-gray-300 text-white">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm">Panic status.
                                </td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm text-red-500">Required</td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm">[true, false]</td>
                            </tr>
                            <tr>
                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium sm:pl-0">
                                    location</td>
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-sm">Any string</td>
                            </tr>
                        </tbody>
                    </table>
    ...
    "department_type": 1
                    ...
                    <code
                        ...
                        <span class="flex gap-4">
                            <pre class="flex-1">
{
    "error": "No active unit given for the user_id"
}
                            </pre>
                        </span>
                    </code>
