                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium sm:pl-0">
                                    nature</td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm">string</td>
                                <td class="whitespace-nowrap px-3 py-4 text-sm">Type of Call. <a class="underline"
                                        href="#nature_codes">List
                                        of all call Nature Codes.</a>
                                </td>
...
"created_at": "2024-04-03T03:09:05.000000Z"
                    ...
                    <p>200 with error message if the nature or source was not accepted.</p>
                    <code
                        class="text-sm sm:text-base inline-flex text-left items-center space-x-4 bg-gray-800 text-white rounded-lg p-4 pl-6">
                        <span class="flex gap-4">
                            <pre class="flex-1">
{
    "error": "Source|Nature not available"
}
                            </pre>
                        </span>
                    </code>
                ...
                <div class="space-y-3" id="nature_codes">
                    ...
                    <ul class="list-inside list-disc">
                        ...
                        <li><span class='font-bold text-lg'>TRAFFICA</span> - TRAFFIC TRANSPORTATION ACCIDENT (CRASH)</li>
